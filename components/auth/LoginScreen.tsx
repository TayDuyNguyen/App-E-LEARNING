...
const LoginScreen: React.FC<LoginScreenProps> = ({ onLogin, onGoToRegister, onGoToForgot }) => {
  ...
  return (
    <div className="flex-1 flex flex-col p-8 bg-[#0F172A] animate-in slide-in-from-right duration-500 overflow-y-auto scrollbar-none">
      <div className="pt-10 pb-12">
        <h2 className="text-4xl font-black text-white tracking-tight leading-tight mb-3">Chào mừng <br/>trở lại! 👋</h2>
        <p className="text-slate-400 font-medium">Tiếp tục hành trình chinh phục tri thức.</p>
      </div>

      <div className="space-y-8 flex-1">
        {/* Email */}
        <div className="space-y-3">
          <label className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] ml-1">Địa chỉ Email</label>
        ...
        {/* Password */}
        <div className="space-y-3">
          <label className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] ml-1">Mật khẩu</label>
          <div className="relative group">
