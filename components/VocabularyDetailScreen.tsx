  ...
  return (
    <div className="flex flex-col h-screen bg-[#0F172A] text-white animate-in zoom-in-95 duration-500 overflow-y-auto scrollbar-none pb-32">
      ...
      <div className="px-8 pt-4 space-y-10">
        ...
        <div className="bg-indigo-600/10 border border-indigo-500/20 p-6 rounded-[32px] flex items-center justify-between group cursor-pointer hover:bg-indigo-600/20 transition-all">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-indigo-600 rounded-2xl flex items-center justify-center text-white shadow-lg">
              <MessageSquare className="w-6 h-6" />
            </div>
            <div>
              <h4 className="text-sm font-black text-white">Hỏi thêm về từ này?</h4>
              <p className="text-[10px] font-bold text-indigo-400 uppercase tracking-widest">Gia sư AI Lumina sẵn sàng</p>
            </div>
          </div>
        </div>
      </div>
